from src.fig import transactions
def filter_by_currency(transactions: list[dict], currency: str) -> int:
...
def card_number_generator(start, end):
    for num in range(start, end+1):
        yield '{:04d} {:04d} {:04d} {:04d}'.format((num // 10**12) % 10**4, (num // 10**8) % 10**4, (num // 10**4) % 10**4, num % 10**4)
